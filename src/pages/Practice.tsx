...
const practiceAreas = [
  {
    ...
    description:
      "Our litigation team has decades of combined courtroom experience across diverse areas including:",
    details: [
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <p className="text-xl text-white/70 leading-relaxed">
              Comprehensive legal services across a wide range of practice
              areas, delivered with expertise and dedication to achieving the
              best outcomes.
            </p>
          </motion.div>
        </div>
            ...
            <div className="container-custom">
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`absolute -bottom-6 ${index % 2 === 0 ? "-right-6" : "-left-6"} w-24 h-24 bg-accent/20 rounded-2xl -z-10`}
                  />
                </motion.div>
              </div>
            </div>
